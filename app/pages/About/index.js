...
export default class extends Page {
  constructor () {
    ...
    const socials = [
      {
        label: 'Twitter',
        url: 'https://www.twitter.com/guptaprabith/'
      },
      {
        label: 'Instagram',
        url: 'https://www.instagram.com/pra3ith/'
      },
      {
        label: 'GitHub',
        url: 'https://www.github.com/prabhigupta/'
      },
      {
        label: 'LinkedIn',
        url: 'https://www.linkedin.com/in/prabithGS/'
      },
      {
        label: 'Email',
        url: 'mailto:prabith7.g.s@gmail.com'
      }
    ]
